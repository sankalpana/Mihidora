...
function ResourceJobsNew() {
    ...
    const handleChange = (e) => {
        ...
        filterProjects({ filters: data, district: e.target.value, type: 1 });
    }
    ...
    const handleKeyPress = (event) => {
        if (event.key === 'Enter') {
            ...
            search({ "term": event.target.value, type: 1 });
        }
    };
        ...
        <BaseLayout title={"Topic"}>
                ...
                <Container>
                    <Grid container>
                        <Grid item sm={12} md={6} lg={6}>
                            ...
                            {/* <PublicSubscriptionComponent topic="jobs" title="Jobs" /> */}
                            <PublicSubscriptionAll topic="All Topics" title="All Topics" />
                        </Grid>
                        <Grid item sm={12} md={6} lg={6}>
                            <div className="section-links">
                                <div style={{ marginRight: '20px' }}><ProjectLink visited name="Jobs" link={'/resource-exchange/jobs'} icon={<NaturePeopleIcon fontSize="small" className="iconVisited" />} /></div>
            ...
            <Dialog fullScreen open={open} onClose={handleClose} disableEnforceFocus>
                ...
                <DialogContent disablePadding sx={{ paddingLeft: '0px', paddingRight: '0px' }}>
                    <FMap topic={'resource-exchange-job'} />
                </DialogContent>
            </Dialog>
        </BaseLayout>
    )
...
export default ResourceJobsNew
