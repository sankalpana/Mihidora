                        ...
                        <Grid item sx={{ width: '100%' }}>
                            <div style={{ position: 'relative', height: '600px', width: `${drawerWidth}px`, maxWidth: '100%' }}>
                                <Map
                                    ...
                                    zoom={18}
                                    initialCenter={{
                                        lat: 6.778670099999999,
                                        lng: 80.40515155292006
                                    }}
                                >
                                    ...
                                    <Marker
                                        name={'Location 1'}
                                        position={{ lat: 6.868541278372921, lng: 80.40345948463631 }} />
                                    <Marker />
                                    <Marker
                                        name={'Location 2'}
                                        position={{ lat: 6.866630116539684, lng: 80.41462432852182 }} />
                                    <Marker />
                                    <Marker
                                        name={'Location 3'}
                                        position={{ lat: 6.8652285929828345, lng: 80.40596194964513 }} />
                                    <Marker />
                                    <InfoWindow
                                        marker={activeMarker}
