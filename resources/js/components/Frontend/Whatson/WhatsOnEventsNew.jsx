...
function WhatsOnEventsNew() {
  ...
  const handleL1Change = (e) => {
    ...
    console.log(data);
    filterProjects({ filters: data, district: state.district, type: 1 });
  }
        ...
        <Container>
          <Grid container>
            <Grid item sm={12} md={6} lg={6}>
              ...
              {/* <PublicSubscriptionComponent topic="events" title="Events" /> */}
              <PublicSubscriptionAll topic="All Topics" title="All Topics" />
            </Grid>
            <Grid item sm={12} md={6} lg={6}>
              <div className="section-links">
                <div style={{ marginRight: '20px' }}><ProjectLink visited name="Events" link={'/whatson/events'} icon={<CalendarMonthIcon fontSize="small" className="iconVisited" />} /></div>
