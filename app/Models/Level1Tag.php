...
class Level1Tag extends Model
{
    ...
    {
        return $this->morphedByMany(WhatsOn::class, 'level1_taggable', 'level1_taggables');
    }
    ...
    {
        return $this->morphedByMany(Organizations::class, 'level1_taggable', 'level1_taggables');
    }
}
