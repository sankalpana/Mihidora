...
function SupplierProfileNew(props) {
    ...
    const getProjectProfile = () => {
        axios.get(`/api/resource-exchange-supplier/${postParams.slug}`).then(res => {
                    ...
                    <Grid container>
                        <Grid item sm={12} md={6} lg={6} mt={3}>
                            <Link style={{
                                ...
                                <Typography sx={{ fontSize: '12px' }}>{`Resource Exchange > Suppliers`}</Typography>
                            </Link>
                        </Grid>
                    </Grid>
                    <Grid container>
