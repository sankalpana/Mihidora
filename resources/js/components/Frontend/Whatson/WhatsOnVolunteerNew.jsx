...
function WhatsOnVolunteerNew() {
  ...
  useEffect(() => {
    loadProjects({ skip: 0, take: 50, type: 3 });
  ...
  const handleL1Change = (e) => {
    ...
    console.log(data);
    filterProjects({ filters: data, district: state.district, type: 3 });
  }
  ...
  const handleChange = (e) => {
    ...
    filterProjects({ filters: data, district: e.target.value, type: 3 });
  }
  ...
  const handleKeyPress = (event) => {
    if (event.key === 'Enter') {
      ...
      search({ "term": event.target.value, type: 3 });
    }
  };
    ...
    <BaseLayout title={"Topic"}>
        ...
        <Container>
          <Grid container>
            <Grid item sm={12} md={6} lg={6}>
              ...
              {/* <PublicSubscriptionComponent topic="volunteer" title="Volunteer Opportunities" /> */}
            ...
            <Grid item sm={12} md={6} lg={6}>
              <div className="section-links">
                ...
                <div style={{ marginRight: '20px' }}><ProjectLink visited name="Volunteer Opportunities" link={'/whatson/volunteer-opportunities'} icon={<NaturePeopleIcon fontSize="small" className="iconVisited" />} /></div>
                <div style={{ marginRight: '20px' }}><ProjectLink name="Media & Advocacy" link={'/whatson/media-and-advocacy'} icon={<AutoStoriesIcon fontSize="small" className="iconActive" />} /></div>
              </div>
            </Grid>
          </Grid>
        </Container>
      ...
      <div id="datasets" className="topic-sub-section">
        <Container>
          ...
          <Grid container>
            <Grid item xs={6}>
              <Typography variant="h4" className="section-title">Volunteer Opportunities</Typography>
            </Grid>
              ...
              {projectList.map((project, key) => (
                <Grid item key={key} xs={3} className="organization_card" >
                  <Link style={{
                    ...
                    borderRadius: '10px'
                  }} to={`/whatson-volunteer-opportunity/` + project.slug}>
...
export default WhatsOnVolunteerNew
