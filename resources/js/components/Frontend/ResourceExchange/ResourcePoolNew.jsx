...
function ResourcePoolNew() {
    ...
    useEffect(() => {
        loadProjects({ skip: 0, take: 50, type: 4 });
        loadDistricts();
    }, []);
    ...
    const handleChange = (e) => {
        ...
        filterProjects({ filters: data, district: e.target.value, type: 4 });
    }
    ...
    const handleKeyPress = (event) => {
        if (event.key === 'Enter') {
            ...
            search({ "term": event.target.value, type: 4 });
        }
    };
        ...
        <BaseLayout title={"Topic"}>
                ...
                <Container>
                    <Grid container>
                        <Grid item sm={12} md={6} lg={6}>
                            <Typography sx={{ fontSize: '12px' }}>Resource Pool</Typography>
                            <Typography variant="h1">Resources</Typography>
                            {/* <PublicSubscriptionComponent topic="resources" title="Resources" /> */}
                        ...
                        <Grid item sm={12} md={6} lg={6}>
                            <div className="section-links">
                                ...
                                <div style={{ marginRight: '20px' }}><ProjectLink name="Grants & RFPs" link={'/resource-exchange/grants-and-proposals'} icon={<NaturePeopleIcon fontSize="small" className="iconActive" />} /></div>
                                ...
                                <div style={{ marginRight: '20px' }}><ProjectLink visited name="Resource Pool" link={'/resource-exchange/resource-sharing'} icon={<ArchitectureIcon fontSize="small" className="iconVisited" />} /></div>
                            </div>
                        </Grid>
                    </Grid>
                </Container>
            ...
            <div id="datasets" className="topic-sub-section">
                <Container>
                    ...
                    <Grid container>
                        <Grid item xs={6}>
                            <Typography variant="h4" className="section-title">Resource Pool</Typography>
                        </Grid>
            ...
            <Dialog fullScreen open={open} onClose={handleClose} disableEnforceFocus>
                ...
                <DialogContent disablePadding sx={{ paddingLeft: '0px', paddingRight: '0px' }}>
                    <FMap topic={'resource-exchange-resource-sharing'} />
                </DialogContent>
            </Dialog>
        </BaseLayout>
    )
}
export default ResourcePoolNew
