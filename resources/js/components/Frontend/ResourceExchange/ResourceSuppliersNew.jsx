    ...
    <BaseLayout title={"Topic"}>
        ...
        <Container>
          <Grid container>
            <Grid item sm={12} md={6} lg={6}>
              ...
              {/* <PublicSubscriptionComponent topic="suppliers" title="Suppliers" /> */}
            ...
            <Grid item sm={12} md={6} lg={6}>
              <div className="section-links">
                ...
                <div style={{ marginRight: '20px' }}><ProjectLink visited name="Suppliers" link={'/resource-exchange/suppliers'} icon={<TextSnippetIcon fontSize="small" className="iconVisited" />} /></div>
      ...
      <Dialog fullScreen open={open} onClose={handleClose} disableEnforceFocus>
        ...
        <DialogContent disablePadding sx={{ paddingLeft: '0px', paddingRight: '0px' }}>
          <FMap topic={'resource-exchange-supplier'} />
        </DialogContent>
      </Dialog>
    </BaseLayout>
  )
}
export default ResourceSuppliersNew
