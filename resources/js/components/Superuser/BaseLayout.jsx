  ...
  const drawer = (
    <div>
      ...
      <List sx={{ px: '2rem' }}>
        ...
        <ListItem key='disabledOrganizations' disablePadding>
          <ListItemButton
            className={`${location.pathname == '/admin/organizations-disabled' ? 'sideBarButtonHighlight' : ''} sidebar-button`}
            component="a" href="/admin/organizations-disabled">
            <ListItemIcon sx={{ minWidth:'40px' }}>
              <MapsHomeWorkIcon fontSize="small" />
            </ListItemIcon>
            <ListItemText primary='Inactive Orgs' />
          </ListItemButton>
        </ListItem>
