...
const PublicSubscriptionAll = ({ topic, title }) => {
    ...
    const apiCall = () => {
        ...
        axios.get('/sanctum/csrf-cookie').then(response => {
            axios.post('/api/subscribe-public-all', data).then(res => {
                console.log(res)
                if (res.status == 200) {
        ...
        <div>
            ...
            >
                ...
                >
                    ...
                    <Typography variant="h2" sx={{ fontSize: '1.75rem' }}>Subscribe to Mihidora</Typography>
                    <Typography variant="caption" display="block" gutterBottom sx={{ maxWidth: '400px' }}>
                        Sign up for our weekly newsletter to get the inside scoop on all the latest submissions from our vibrant community. Discover new voices, be inspired by fresh ideas, and never miss a beat.
                    </Typography>
...
export default PublicSubscriptionAll;
