...
class AnalyticsController extends Controller
{
    ...
    public function getResourceStats()
    {
        ...
        $organisations = Organizations::count();
        $events = WhatsOn::where('type', '=', 1)->count();
        $mediaAdvocacy = WhatsOn::where('type', '=', 2)->count();
        $dataEducation = DataEducation::count();
        ...
        return response()->json([
            ...
            'events' => $events,
            'knowledge_products' => $mediaAdvocacy + $dataEducation,
        ]);
    }
}
